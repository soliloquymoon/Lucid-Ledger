function dream_draw_item(xx, yy, dream, scale = 1){
	...
	draw_sprite_stretched(spr_frame, 7, xx + 350 * scale, yy + 21 * scale, 4 * scale, 96 * scale)
	...
	draw_text_transformed(xx + 406 * scale - string_width(value_str) / 2 * scale, yy + 60 * scale, value_str, scale, scale, 0)
}